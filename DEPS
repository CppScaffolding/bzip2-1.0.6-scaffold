# -----------------------------------------------------------------------------
# DEPS file for bzip2-1.0.6 scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# bzip2-1.0.6-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'bzip2-1.0.6': 'https://github.com/enthought/bzip2-1.0.6.git@{bzip2-1.0.6_revision}',
  # keep
  # this
  # line
}
